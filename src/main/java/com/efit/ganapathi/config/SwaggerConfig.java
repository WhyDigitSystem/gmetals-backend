package com.efit.ganapathi.config;
...
public class SwaggerConfig {
	...
	private ApiInfo getApiInfo() {
		return new ApiInfo("Spring Boot Ganapathi-Metals package REST API",
				"Spring Boot REST API for Ganapathi-Metals package service", "1.0.0", "Terms of Service",
