...
import com.efit.ganapathi.dto.RolesResponsibilityDTO;
import com.efit.ganapathi.dto.ScreensDTO;
import com.efit.ganapathi.dto.SignUpFormDTO;
import com.efit.ganapathi.dto.UserResponseDTO;
import com.efit.ganapathi.dto.UserStatus;
...
import com.efit.ganapathi.repo.ScreensRepo;
import com.efit.ganapathi.repo.TokenRepo;
import com.efit.ganapathi.repo.UserActionRepo;
import com.efit.ganapathi.repo.UserBranchAccessRepo;
...
//	}
	...
	public UserResponseDTO login(LoginFormDTO loginRequest, HttpServletRequest request) throws ApplicationException {
		...
		// Email OTP check
		Optional<EmailOtpEntity> emailOtpEntity =
		        emailOtpRepo.findByEmailAndVerified(userVO.getEmail(), true);
		...
		boolean passwordMatch =
		        compareEncodedPasswordWithEncryptedPassword(loginRequest.getPassword(), userVO.getPassword());
...
//		List<UserLoginRolesVO> loginRolesVOs = userVO.getRoleAccessVO();
	...
	@Override
	public Map<String, Object> getUsersByOrgId(Long orgId, String branchCode, String search, int page, int count) {
	    if (search == null) search = "";

	    Pageable pageable = PageRequest.of(page - 1, count); // Page 1 → offset 0
	    Page<Map<String, Object>> userPage = userRepo.getUsersByOrgId(orgId, branchCode, search, pageable);
